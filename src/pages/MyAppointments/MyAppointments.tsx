...
export const MyAppointments: React.FC = () => {
  ...
  const handleCompleteAppointment = async (values: CompletionData) => {
    ...
    try {
      const response = await axios.put(`http://localhost:5000/feedback/${selectedAppointmentId}`, {
  ...
  const handleCancelAppointment = async () => {
    ...
    try {
      const response = await axios.post('http://localhost:5000/cancel_appointment_by_doctor', {
